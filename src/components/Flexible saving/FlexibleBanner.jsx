...
import FlexBannerImg from "../../assets/Mobile22.png";
...
const FlexibleBanner = (props) => {
  return (
    <Container>
      <TopTxtContainer>
        <LeftTitleBox>{props.Name}</LeftTitleBox>
        <TextRightBox>
          <Title>{props.LeftHead}</Title>
      ...
      <MainimgBanner>
        <FlexMobileImage src={FlexBannerImg} alt="Banner" />
      </MainimgBanner>
    </Container>
  );
};
