        ...
        <div className="mainSimBox">
          ...
          <div className="simLowerBox">
            <div className="simpImg">
              <img src={MidMobileImg} alt="Crypto Tax Illustration"  style={{height: "30rem", width: "20rem"}}/>
            </div>
            <div className="simpIconBox">
              <div className="simpBoxPoints">
                <h4>
                  <HiOutlineDocumentText className="fawallet" size={35} /> Import
                  your Syzyky transaction history.
                </h4>
              </div>
              <div className="simpBoxPoints">
                <h4>
                  <BsPlusSlashMinus className="fawallet" size={35} /> Calculate
                  capital gains, losses, and income.
                </h4>
              </div>
              <div className="simpBoxPoints">
                <h4>
                  <CiBank className="fawallet" size={35} /> Generate reports
                  tailored to your local tax regulations.
                </h4>
              </div>
