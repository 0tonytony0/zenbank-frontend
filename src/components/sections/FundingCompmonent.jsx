      ...
      <Container>
        ...
        <Cards>
          <Card initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            ...
            <CardDescription>
              Your personal USD, EUR, and GBP accounts on AI Key help you prevent blocked or delayed transactions that banks can impose on third-party transfers. Adding funds is fee-free for EUR and GBP transfers, and USD amounts over $5,000.
            </CardDescription>
          </Card>
